...
def render_roster(config: dict) -> str:
    lines = [
        ...
        '',
        'This file is rendered from your local config.',
        'Verify every bot username, bot ID, and capability flag against your current Telegram runtime before relying on it.',
        '',
...
def render_profile_routing(config: dict) -> str:
    ...
    lines = [
        ...
        '',
        'This file is rendered from your local role/capability config. It gives a fast routing map, but it does not replace reading the underlying role docs when boundaries are important.',
        '',
        '## Primary rule',
        '',
